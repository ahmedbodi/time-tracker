...
--
-- Host: localhost    Database: time_system
-- ------------------------------------------------------
...
CREATE TABLE `leave_entitlement` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_49926576A76ED395` (`user_id`),
  CONSTRAINT `FK_49926576A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
INSERT INTO `leave_entitlement` VALUES (1,1,0);
...
CREATE TABLE `leave_request` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_7DC8F778A76ED395` (`user_id`),
  CONSTRAINT `FK_7DC8F778A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
-- Dump completed on 2019-03-09 19:21:51
